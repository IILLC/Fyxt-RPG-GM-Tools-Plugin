(function( $ ) {
	...
	jQuery( document ).ready(function( $ ) {
		...
		$( "#encounter_summary_content" ).keyup(function () {
		   ...
		   //console.log("Totally firing keyup 1");
		});
		...
		$(function() {
		  	$( "button[name=btn_save_encounter]" )  
				.click(function( event ) {
					...
					//gets too much from tinymce
				//const forms = document.querySelectorAll('#encounter_form');
//				const form = forms[0];
//
...
//					}
				...
				//var test_tinymce_item = tinymce.get('encounter_summary_content')
				//console.log(test_tinymce_item);
				
			});
		});
		
// code to enable id "sortable" not using this at this time. Doesn't work on moble and can mess up round rearranging. 
//		$( function() {
//			$( "#sortable" ).sortable();
...
//		  } );
		...
		$(function() {
		  	$( "select[name*=slct_round_difficulty]" )  
				.click(function( event ) {
					event.preventDefault();
					console.log("round difficulty clicked");	
		...
		//code for the delete button for rounds during TT
